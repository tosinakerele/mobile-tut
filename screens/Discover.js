    ...
    <SafeAreaView className="flex-1 bg-white relative">
      ...
      {isLoading ? (
        ...
        <ScrollView className="">
          ...
          {/* nav section */}
          <View>
            <View className="flex-row items-center justify-between px-6 mt-14">
              <Text className="text-[#2C7379] font-bold text-[28px]">
                Top Tips
              </Text>
              <TouchableOpacity className="flex-row items-center justify-center space-x-2">
                <Text className="font-bold text-[20px] text-[#A0C4C7]">
                  Explore
                </Text>
